...
#define PILI_FOTOS_EVENTO    6        // frames por chegada (a nuvem vota entre eles)
#define PILI_COOLDOWN_MS     5000UL   // silêncio após um evento
#define PILI_ASSENTAR_MS     1000UL   // espera a cena assentar antes da 1ª foto
#define PILI_ENTRE_FOTOS_MS  500UL    // intervalo entre as fotos da rajada
