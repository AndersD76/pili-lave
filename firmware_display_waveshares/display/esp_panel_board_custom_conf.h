...
#define ESP_PANEL_BOARD_LCD_MIRROR_X            (0)     // 0/1 — REVERTIDO: mirror por hardware quebrou o
#define ESP_PANEL_BOARD_LCD_MIRROR_Y            (0)     // 0/1   touch (não bastava espelhar X+Y do touch junto).
                                                        //        Voltando pro rotate-by-software (funcionava,
                                                        //        só tinha o drift) até investigar direito.
