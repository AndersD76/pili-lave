...
export type SessionUser = { id: string; phone: string; role: "CLIENT" | "LAVADOR" | "PARCEIRO" | "ADMIN" };
...
export async function requireUser(req: NextRequest, role?: "LAVADOR" | "PARCEIRO" | "ADMIN") {
